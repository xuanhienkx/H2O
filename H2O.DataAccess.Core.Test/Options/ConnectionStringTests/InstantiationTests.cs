...
using H2O.DataAccess.Core.Options;
using Xunit;
using Xunit.Abstractions;

namespace H2O.DataAccess.Core.Test.Options.ConnectionStringTests
{
    public class InstantiationTests
    {
        private readonly ITestOutputHelper output;

        public InstantiationTests(ITestOutputHelper output)
        {
            this.output = output;
        }
        [Fact]
